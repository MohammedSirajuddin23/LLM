...
<body>
        ...
        <div class="master-frame">
                <iframe onload="resizeIframe(this);" class="top" src="http://10.255.23.37:15871/cgi-bin/block_message.cgi?ws-session=-1881820160" name="ws_block" frameborder="0" scrolling="auto" style="width:100%; padding-bottom:15px;">
                </iframe>

                <iframe onload="resizeIframe(this);" class="bottom" src="http://10.255.23.37:15871/cgi-bin/blockOptions.cgi?ws-session=-1881820160" name="ws_blockoption" frameborder="0" scrolling="auto" style="width:100%;">
        ...
        <div id="fade" class="black_overlay">
                <div id="light" class="white_content">
                        ...
                        <form action="/cgi-bin/useraccount_overrider.cgi" method="POST" target="_top" name="UAOverrideForm" onsubmit="encode();">
                                <input type="HIDDEN" name="ws-session" value="-1881820160">
...
<script type="text/javascript">
        ...
        var casbFlag="false";
        var WS_MOREINFOCGIDATA = "d3MlMkRzZXNzaW9uPTE4NDQ2NzQ0MDcxODI3NzMxNDU2JndzJTJEdXNlcmlwPTEwJTJFMTQ1JTJFMzklMkU4MSZ3cyUyRGNhdD05JndzJTJEcmVhc29uPTEwNjE=";
        var WS_ACEINSIGHT_LINK_URL = "https://csi.forcepoint.com/blockpage.aspx?url=https://cdn.branch.io/branch-latest.min.js&lang=en&blockcat=9&cat1=9-1";
</script>
        ...
        <center>
                    ...
                    <div class="page_box">
                      <header>
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="logo"> <span><img src="/Images/logo.png"/></span> </div>
                          </div>
                        </div>
                      </header>
                      <div class="pagebody">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="pagebodyinner">
                              <div class="w100">
                                <div class="errorbox"> <span><img src="/Images/403.png"/></span> </div>
                                <h1>We are sorry, the URL you requested is not accessible due to Information Security Guidelines</h1>
                                <p>We are here to help you. If this access is required for work related reasons, <br>
                                  please call <a href="tel:+97147016444">+97147016444</a> or email <a href="mailto:THC@dib.ae">THC@dib.ae</a></p>
                              </div>
							  
							  <div class="w100 pb-3">
							 
							  <input type="button" onclick="return goToMoreInfo();" value="More Information" name="ws-more-info" class="button custombutton">
							  <span>Learn more about why this site is blocked.</span>
							  </div>
							  <!--<div class="w100">
							  <form name="BackForm" action="">
                                                <input type="button" value="Go Back" onclick="return goBack();" name="ws-back" class="button custombutton">
												 <span>Click <b>Go Back</b> or use the browser's Back button to return to the previous page.</span>
                                        </form>
							  </div>  -->
                            </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                          <div class="w100 footerleft">
                            <h3>© 2021 Dubai Islamic Bank. All rights reserved.</h3>
                          </div>
                        </div>
						
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                          <div class="w100 footerright">
                            <h3>Your IP Address: <span>10.145.39.81</span> | Your Username: <span>Muhammad Kamran Noor</span> |  URL:<span>https://cdn.branch.io/branch-latest.min.js </span></h3>
                          </div>
                        </div>
                      </div>
                    </footer>
          ...
          <p><a style="color:#bab9ba;" href="https://urldefense.proofpoint.com/v2/url?u=http-3A__CHANGE-5FTO-5FACCEPTABLE-5FUSAGE-5FPOLICY&d=DwMGAg&c=pK0m1Y2YHijnQdgo_W0o4Q&r=SDiPcaGuYvPVCksfm-2rUJs0eiEcV4e9KyFPcRRiL5E&m=3KOK1CNHeWos8QMtbQB8AGx_IYsvxuRNvviuYidQ3iY&s=zM5T1YFKiqVkzV46niyAix_xvo_APVdBkCmPLvyDbpQ&e=">Internet Usage Policy</a> </p>
...
.dropdown-m$enu-md-start[data-bs-popper] { right: auto; left: 0 }
...
.align-sel$f-start { align-self: flex-start!important }
...
.text-body {
--bs-text-opacity:1; color: rgba(var(--bs-body-rgb), var(--bs-text-opacity))!important }
.text-muted {
--bs-text-opacity:1; color: #6c757d!important }
.text-black-50 {
...
.bg-body {
--bs-bg-opacity:1; background-color: rgba(var(--bs-body-rgb), var(--bs-bg-opacity))!important }
.bg-transparent {
...
a:hover { color: #7bb73b; text-decoration: underline; }
html { scroll-behavior: smooth; }
body { font-family: 'Neo_Sans_Std_Regular'; font-size: 16px; color: #bab9ba; outline: none; overflow-x: hidden; }
.w100 { width: 100%; float: left; }
.nobg { background: none !important; }
p { width: 100%; float: left; font-size: 20px; color: #bab9ba; line-height: 36px; text-align: center; }
h1 { width: 100%; float: left; font-size: 30px; font-family: 'Neo_Sans_Std_Regular'; color: #a39160; line-height: normal; text-align: center; }
h2 { width: 100%; float: left; font-size: 24px; font-family: 'Neo_Sans_Std_Regular'; color: #991427; line-height: normal; }
h3 { width: 100%; float: left; font-size: 14px; font-family: 'Neo_Sans_Std_Regular'; font-weight: 600; color: #991427; line-height: normal; }
.pagebox { width: 100%; float: left; }
.pageinner { width: calc(100% - 10px); float: left; margin: 20px 5px; padding: 40px; border: 1px solid #dfdfdf; }
header { width: 100%; float: left; }
.logo { width: auto; float: left; }
.logo span { width: auto; float: left; }
.logo span img { width: auto; float: left; }
.together { width: 100%; float: right; padding: 23px 0; }
.together h2 { width: 100%; float: right; text-align: right; margin: 0; padding: 0; }
.pagebody { width: 100%; float: left; text-align: center; }
.pagebodyinner { width: 100%; max-width: 716px; float: none; display: inline-block; padding: 0 0 50px 0; }

.pagebodyinner p a { color: #bab9ba; }
.errorbox { width: 100%; float: left; text-align: center; }
.errorbox span { width: auto; float: none; text-align: center; display: inline-block; }
.errorbox span img { width: auto; float: left; }
.page_box { width: 100%; float: left; position: relative; }
footer { width: 100%; float: left; }
.footerleft { width: 100%; float: left; }
.footerleft h3 { width: 100%; float: left; text-align: left; margin: 0; padding: 0; }
.footerright h3 { width: 100%; float: left; text-align: right; margin: 0; padding: 0; }
.custombutton{border:none; background:none; color:#bab9ba; text-decoration:underline;}
@media (min-height: 750px) and (max-height:5000px) {
.pageinner { height: calc(100vh - 40px); }
.page_box { width: 100%; float: left; position: relative; height: 100%; }
footer { width: 100%; float: left; bottom: 0; position: absolute; }
.page_box { position: relative; }
.pagebody { position: absolute; top: 50%; transform: translateY(-50%); }
}

@media (min-width: 300px) and (max-width:991px) {
.footerleft h3 { text-align: center; margin: 0 0 10px 0; }
.footerright h3 { text-align: center; }
.logo { width: 100%; text-align: center; }
.logo span { display: inline-block; float: none; }
.together h2 { text-align: center; }
}

@media (min-width: 300px) and (max-width:800px) {
.errorbox span { width: 100%; float: left; }
.errorbox span img { width: 100%; float: left; }
}

@media (min-width: 300px) and (max-width:767px) {
.pageinner { padding: 30px 10px; }
}
</style>
